...
class Dnd(QMainWindow):
    def __init__(self):
        ...
        file = open('../Яндекс проект/save_for_hods.txt', mode='w', encoding='UTF-8')
        file.write('1\n')
        file.close()
    ...
    def reading_files(self):
        file = open('../Яндекс проект/save_for_hods.txt', 'r', encoding='UTF-8')
    ...
    def set_result(self, result, result_for_big_button=None):
        ...
        file = open('../Яндекс проект/save_for_hods.txt', mode='a', encoding='UTF-8')
