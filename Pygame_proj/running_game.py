...
def running_game(fps, difficulty, width, height, screen):
    ...
    class Player(pygame.sprite.Sprite):
        ...
        def upgrade(self, upgrader):
            if upgrader == "health":
                ...
                pass                  #тут увелич частоту выстрелов
            elif upgrader == "speed":
                pass                       #тут увелич 
            else:
                pass           #тут увелич тут урон героя
    ...
    class Bullet(pygame.sprite.Sprite):
        ...
        def __init__(self, *group, pos_player, pos_click):
            ...
            hypotenuse = math.hypot(*self.dir)
            if hypotenuse == 0:
                self.dir = (0, -1)
            else:
                self.dir = (self.dir[0] / hypotenuse, self.dir[1] / hypotenuse)
    ...
    while running:
        ...
        Title(titles, pos=(width // 12 - 50, height // 12), slides_and_sizes=[["score_t_proj.png", (123, 30)]])

        temp_score_hud = Hud(text=score, size=45, color=(255, 255, 255), screen=screen,
                             pos=(width // 12 + 30, height // 12 - 32))
        clock.tick(fps)
        player.update()
        bullets.update()
